/******/ (() => {
    ...
    chrome.runtime.onMessage.addListener(async function (
      ...
      if (request.message == "remove") {
        ...
        function crosshairCss() {
          return (
            "url(" + chrome.runtime.getURL("plus.png") + ") 16 16,crosshair"
          );
        }
        ...
        document.body.addEventListener("click", function () {
          ...
          mydiv &&
            mydiv.childElementCount > 2 &&
            mydiv.removeChild(innerCanvas);
  ...
  const createModal = () => {
    ...
    document.querySelector(".cp-container .cp-image").src =
      chrome.runtime.getURL("logo.svg");
    document.querySelector(".cp-container .cp-pickimage").src =
      chrome.runtime.getURL("pickicon.svg");
    ...
    document
      .querySelector(".cp-header button")
